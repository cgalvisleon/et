...
* @return string
**/
func (d *Mysql) Type() string {
	return linq.Mysql.String()
}
...
**/
func (d *Mysql) Mode() linq.ModeDatabase {
...
* @return error
**/
func (d *Mysql) Connect(params *linq.Connection) (*linq.DB, error) {
	if d.db != nil {
		return d.db, nil
	}
...
* @return error
**/
func (d *Mysql) Master(params *linq.Connection) (*linq.DB, error) {
	if d.dm != nil {
		return d.dm, nil
	}
...
**/
func init() {
	linq.Register(linq.Mysql.String(), NewDriver)
}
