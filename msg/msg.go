...
const (
	...
	MSG_USER_INVALID        = "usuario no valido, atributo (%s)"
	MSG_MAIL_001            = "verifica tu direccion de correo electronico"
	MSG_MAIL_002            = "codigo de validacion"
	MSG_MOBILE_VALIDATION   = "%s: codigo de validacion %s. su codigo expira en 3 minutos."
	...
	RECORD_NOT_CHANGED      = "No hay cambios en el registro"
