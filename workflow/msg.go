...
var (
	...
	MSG_FLOW_ALREADY_EXISTS         = "flow already exists"
	...
	MSG_INSTANCE_ERROR              = "Instancia eror Id:%s Tag:%s Step:%d err:%v"
	MSG_INSTANCE_ROLLBACK_ERROR     = "Instancia rollback eror Id:%s Tag:%s Step:%d err:%v"
	MSG_INSTANCE_DELETE             = "Instancia eliminada Id:%s"
	...
	MSG_STEP_NOT_FOUND_IN_STEPPER   = "step %d not found in steper"
	MSG_INVALID_STEPER_TAG          = "tag del steper invalido:%s"
	MSG_INVALID_STEPER_INDEX        = "invalid steper index: %d"
	MSG_CHECK_LIST_NOT_FOUND        = "check list not found"
	MSG_STEPER_ALREADY_EXISTS       = "steper already exists:%s"
